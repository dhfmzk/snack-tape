...
const TRANSLATIONS: Record<Language, Omit<I18n, 'language'>> = {
  ko: {
    ...
    settings: {
      ...
      resetSettingsHelp: '믹스테이프와 클립은 유지됩니다.',
      resetSettingsConfirm: '앱 설정을 기본값으로 되돌릴까요? 믹스테이프와 클립은 유지됩니다.',
      resetSettingsDone: '설정을 기본값으로 되돌렸습니다.',
  ...
  ja: {
    ...
    settings: {
      ...
      resetSettingsHelp: 'ミックステープとクリップは保持されます。',
      resetSettingsConfirm: 'アプリ設定を既定値に戻しますか？ミックステープとクリップは保持されます。',
      resetSettingsDone: '設定を既定値に戻しました。',
  ...
  en: {
    ...
    settings: {
      ...
      resetSettingsHelp: 'Mixtapes and clips stay intact.',
      resetSettingsConfirm: 'Reset app settings to defaults? Mixtapes and clips will stay intact.',
      resetSettingsDone: 'Settings were reset to defaults.',
